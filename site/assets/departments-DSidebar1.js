              ...
              children: [
                ...
                jsx.jsx("tbody", { className: "divide-y divide-border", children: visible.map((department) => {
                  ...
                  return jsx.jsxs("tr", { className: "group hover:bg-surface/60", children: [
                    ...
                    jsx.jsx("td", { className: "px-4 py-3 text-foreground", children: head ? staffName(head) : jsx.jsx("span", { className: "text-warning", children: "No head assigned" }) }),
                    jsx.jsx("td", { className: "px-4 py-3 text-muted-foreground", children: staffCount }),
                    jsx.jsx("td", { className: "px-4 py-3", children: jsx.jsx(StatusPill, { tone: department.status === "active" ? "active" : "archived", children: department.status[0].toUpperCase() + department.status.slice(1) }) }),
    ...
    children: [
      ...
      jsx.jsxs("aside", { className: "admin-detail-sheet", role: "dialog", "aria-modal": "true", "aria-labelledby": "department-detail-title", children: [
        ...
        editing ? jsx.jsxs(jsx.Fragment, { children: [
          ...
          jsx.jsxs("div", { className: "admin-detail-body", children: [
            jsx.jsxs("div", { className: "overflow-hidden rounded-lg border border-border", children: [jsx.jsx(DetailRow, { label: "Code", value: department?.code }), jsx.jsx(DetailRow, { label: "Head", value: head ? staffName(head) : "Unassigned" }), jsx.jsx(DetailRow, { label: "Staff", value: staffCount }), jsx.jsx(DetailRow, { label: "Status", value: department?.status ? department.status[0].toUpperCase() + department.status.slice(1) : "-" })] }),
