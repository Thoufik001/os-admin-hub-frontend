          ...
          jsx.jsxs("div", {
            ...
            children: [
              jsx.jsx(MetricCard, {
                ...
                hint: "Active allow policies",
                tone: "rules",
              }),
              jsx.jsx(MetricCard, {
                label: "Roles",
                value: metrics.roles,
                hint: "With permissions",
                tone: "roles",
              }),
              jsx.jsx(MetricCard, {
                label: "Actions",
                value: metrics.actions,
                hint: policyActions.join("/"),
                tone: "actions",
              }),
              jsx.jsx(MetricCard, {
                label: "Objects",
                value: metrics.objects,
                hint: "Controlled views",
                tone: "objects",
              }),
            ],
          }),
                          ...
                          children: [
                            jsx.jsx("td", {
                              ...
                              children: jsx.jsxs("span", {
                                ...
                                children: [jsx.jsx("span", { className: "orbac-pill-dot" }), policy.role],
                              }),
                            }),
                            jsx.jsx("td", {
                              className: "px-4 py-3",
